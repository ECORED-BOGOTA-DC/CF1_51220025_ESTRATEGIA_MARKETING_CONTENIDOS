...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5(data-aos="fade-left") Elegir correctamente el contenido que comparten las organizaciones resulta clave para alcanzar objetivos del <em>marketing</em> digital y generar campañas exitosas, para ello es necesario realizar este proceso de forma estratégica y por medio del análisis de datos que garanticen un alto impacto en la audiencia. Este proceso comprende las siguientes fases:
    
    .content-card.mb-5(data-aos="fade-right")
      ...
      .col-12.col-lg.d-flex
        .card-edit-row.card-edit-row--last
          p.mb-0.text-center Análisis de resultados

    p.mb-5(data-aos="fade-right") Ahora se desglosará este proceso para su mayor comprensión, esto es:
    ...
    .d-flex.mb-5
      h3.d-flex.align-items-center.py-2.ps-3.pe-4(style="background-color: #FF5A20; border-radius: 50px")
        ...
        span(data-aos="fade-left") Investigación
      
    .d-flex.flex-wrap.mb-5.align-items-center
      .col-lg-9.pe-lg-4.order-2.order-lg-1(data-aos="fade-right")
    ...
    p.mb-5(data-aos="fade-right") Planear las acciones consiste en determinar las tareas específicas que se deben desarrollar para el cumplimiento de los objetivos. Por ejemplo, si uno de los objetivos que se plantea es aumentar el reconocimiento de marca, para esto se deben realizar acciones como definir el responsable, definir el público al que va dirigido, crear la plantilla del correo con un diseño llamativo, definir el contenido y definir fecha y hora del envío.

    .d-flex.mb-5
      h3.d-flex.align-items-center.py-2.ps-3.pe-4(style="background-color: #FF5A20; border-radius: 50px")
        p.mb-0.me-4(style="width: 36px; height: 36px; border-radius: 50%; border: 5px solid white;" data-aos="fade-up")
        span(data-aos="fade-left") Creación de contenido y optimización
    
    p.mb-5(data-aos="fade-right") En esta fase es necesario recordar que el contenido debe estar centrado en las necesidades e intereses de los consumidores, y no directamente en las necesidades de la empresa. Los formatos más usados para la generación de contenido son los siguientes:
    ...
    .d-flex.mb-5
      h3.d-flex.align-items-center.py-2.ps-3.pe-4(style="background-color: #FF5A20; border-radius: 50px")
        p.mb-0.me-4(style="width: 36px; height: 36px; border-radius: 50%; border: 5px solid white;" data-aos="fade-up")
        span(data-aos="fade-left") Distribución de contenido
    ...
    AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta-edit-acordeon" data-aos="fade-left")
      ...
      .row.col-lg-11.mx-auto(titulo="<em>Keywords</em>")
        ...
        .col-md.ps-lg-4
          p Son las palabras claves que se eligen en los sitios web para posicionar y aumentar el tráfico en el sitio, ya que es con base en las palabras clave que los motores de búsqueda presentan los resultados. Para seleccionarlas es necesario identificar dentro del contenido del sitio web las palabras que tengan mayor cantidad de búsquedas. Las <em>keywords</em> pueden ser genéricas, cuando constan de una o dos palabras; semi-genéricas cuando se componen de entre 3 y 5 palabras; y por último las <em>long tail keywords</em>, que superan las 5 palabras. Con base en las <em>keywords</em> que se optimizan los principales motores de búsqueda, por eso resulta tan importante elegirlas correctamente.
          p En base al ciclo de compra del cliente, las palabras claves se pueden clasificar en:
          ul.lista-ul
            li.mb-4
              i.fas.fa-check(style="color: #6936C1")
              | <b><em>Keywords</em> informativas:</b> generan grandes cantidades de búsquedas.
            li.mb-4
              i.fas.fa-check(style="color: #6936C1")
      ...
      .row.col-lg-11.mx-auto(titulo="Fichas Técnicas")
        ...
        .col-md.ps-lg-4
          p Son herramientas que resumen y presentan los aspectos principales del contenido de publicaciones digitales, permite sintetizar la información de mejor manera, de modo que sea más fácil consultarla. Las fichas temáticas incluyen aspectos como el número de la ficha, <em>keywords</em>, temática, breve descripción del contenido, entre otros.
      .row.col-lg-11.mx-auto(titulo="Propuesta Gramatical")
        ...
        .col-md.ps-lg-4
          p La propuesta gramatical abarca las técnicas de <em>meta tags</em> y de etiquetas dinámicas como las que se mencionan a continuación:
          ul.lista-ul
            li.mb-4
              i.fas.fa-check(style="color: #6936C1")
              | <b>Técnicas de <em>meta tags</em>:</b> hacen parte de los documentos HTML y brindan información a los motores de búsqueda con respecto a los aspectos claves de la página web, como título, descripción y <em>keywords</em>. Los <em>meta tags</em> de <em>keywords</em> incluyen palabras claves que le indican al buscador el contenido general o la temática del sitio web.
            li.mb-4
              i.fas.fa-check(style="color: #6936C1")
              | <b>Etiquetas dinámicas:</b> son aquellas que integran herramientas externas para registrar la actividad que tiene un sitio web, permite enviar notificaciones cada vez que se produce una conversión en el sitio. Este tipo de etiquetas son muy útiles principalmente para el <em>marketing</em> de afiliación, que está basado y en el que se paga por el número de conversiones que se generen en la página.
      .row.col-lg-11.mx-auto(titulo="Normalización de datos")
        ...
        .col-md.ps-lg-4
          p Consiste en organizar los metadatos con base en una serie de normas o reglas, si bien no existe un modelo internacional de metadatos, existen unas normas internacionales elaboradas por la ISO/IEC, que se encarga de normalizar los elementos de datos y facilitar el intercambio de información. El modelo más conocido para la normalización de metadatos es el de Dublin Core.
    ...
    .d-flex.flex-wrap.mb-5.align-items-center
      img.mb-4.mb-lg-auto.col-lg-4.mx-auto(src="@/assets/curso/temas/tema3/img-15.png" style="max-width: 400px" data-aos="fade-right")
      .col-lg-8.ps-lg-4(data-aos="fade-left")
    ...
    .d-flex.flex-wrap
      ...
      img.mb-4.mb-md-auto.mx-auto.col-md-5.col-lg-3.col-xl-2.order-1.order-md-2(src="@/assets/curso/temas/tema3/img-16.svg" style="max-width: 185px" alt="imagen decorativa" data-aos="fade-left")      
